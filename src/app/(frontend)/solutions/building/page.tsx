...
const solutionCategories = [
  {
    ...
    subtitle: 'Comprehensive Protection for Residential Buildings',
    description:
      'Integrated video surveillance, smart access, and real-time alerts for a safer, more intelligent building environment.',
    solutions: [
      '24/7 video monitoring of entrances, lobbies, and perimeters',
      'Smart access control for residents, staff, and visitors',
      'Integrated fire and intrusion alarms',
      'Remote management via mobile and web',
      'AI-powered analytics for real-time alerts',
    ],
    image: '/images/building.webp',
  },
  {
    title: 'Key Technology',
    subtitle: 'Advanced Security Technologies',
    description:
      'Core technologies enhancing the security infrastructure with AI and remote accessibility.',
    solutions: [
    ...
    image: '/images/keytech.avif',
  },
  {
    title: 'System Structure',
    subtitle: 'End-to-End Security System Layout',
    description:
      'A detailed layout of building security system components for various access points and environments.',
    solutions: [
      'Entrance: Face recognition camera, access control terminal',
      'Lobby: Video intercom, visitor management',
      'Perimeter: Smart cameras, intrusion detection',
      'Parking: ANPR camera, barrier control',
          ...
          >
            <motion.div className="text-center mb-6 md:mb-8" variants={fadeInUp}>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 md:mb-4">
                Why Choose Dahua Building Solutions?
              </h2>
            </motion.div>
            <motion.div
            ...
            >
              {[
                {
                  icon: TrendingUp,
                  title: 'Enhanced Safety & Control',
                  description:
                    '24/7 monitoring, smart access, and instant alerts for safer residential and commercial buildings.',
                  color: 'bg-red-600',
                },
                {
                  icon: Shield,
                  ...
                  description:
                    'Unified video surveillance, access control, and alarm systems for comprehensive protection.',
                  color: 'bg-gray-600',
                },
                {
                  icon: Cpu,
                  ...
                  description:
                    'AI-powered analytics and remote management for efficient, intelligent building operations.',
                  color: 'bg-red-600',
                },
              ].map((benefit, index) => {
...
export default BuildingSolutionPage
